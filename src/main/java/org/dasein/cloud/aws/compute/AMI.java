...
public class AMI extends AbstractImageSupport {
    ...
    public boolean isSubscribed() throws CloudException, InternalException {
        ...
        try {
            org.dasein.cloud.util.Cache<Map> cache = org.dasein.cloud.util.Cache.getInstance(getProvider(), "isSubscribedVirtualMachine", Map.class, CacheLevel.CLOUD_ACCOUNT);
